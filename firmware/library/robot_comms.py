...
class RobotCommand:
    ...
    _command_dictionary = {
        ...
        "heading":         ( 70, 1, (0, 0, 0, 0), (359, 0, 0, 0), ("Degrees", "", "", ""), "Set the heading"),

        "position-x":      ( 71, 1, (-32767, 0, 0, 0), (32767, 0, 0, 0), ("X Position (mm)", "", "", ""), "Set the X position"),
        "position-y":      ( 72, 1, (-32767, 0, 0, 0), (32767, 0, 0, 0), ("Y Position (mm)", "", "", ""), "Set the Y position"),
        "position":        ( 73, 2, (-32767, -32767, 0, 0), (32767, 32767, 0, 0), ("X Position (mm)", "Y Position (mm)", "", ""), "Set the X, Y position"),
        "towards":         ( 74, 2, (-32767, -32767, 0, 0), (32767, 32767, 0, 0), ("X Position (mm)", "Y Position (mm)", "", ""), "Turn towards the X, Y position"),
        "reset-origin":    ( 77, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("", "", "", ""), "Reset the X, Y origin position and heading"),

        "get-heading":     ( 78, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("", "", "", ""), "Get the heading"),
        "get-position-x":  ( 79, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("", "", "", ""), "Get the X position"),
        "get-position-y":  ( 80, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("", "", "", ""), "Get the Y position"),
        
        "pen":             ( 81, 1, (0, 0, 0, 0), (1, 0, 0, 0), ("Position" , "", "", ""), "Lift the pen up (0 = down, 1 = up)"),
        "eyes":            ( 82, 4, (0, 0, 0, 0), (2, 255, 255, 255), ("Eye ID", "Red", "Green", "Blue"), "Set eye colour (0=both, 1=left, 2=right)"),

        "get-mv":          ( 83, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the voltage (mV)"),
        "get-ma":          ( 84, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the current (mA)"),
        "get-mw":          ( 85, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the power (mW)"),
        "get-pen":         ( 86, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the pen position (0=down, 1=up)"),

        "set-linear-v":    ( 87, 2, (1, 1, 0, 0), (32767, 32767, 0, 0), ("Max mm/s", "Acceleration in mm/s^2", "", ""), "Set the linear velocity"),
        "set-rotation-v":  ( 88, 2, (1, 1, 0, 0), (32767, 32767, 0, 0), ("Max mm/s", "Acceleration in mm/s^2", "", ""), "Set the rotational velocity"),
        "get-linear-m":    ( 89, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the linear max speed (in mm/s)"),
        "get-linear-a":    ( 90, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the linear acceleration (in mm/s^2)"),
        "get-rotation-m":  ( 91, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the rotational max speed (in mm/s)"),
        "get-rotation-a":  ( 92, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the rotational acceleration (in mm/s^2)"),

        "set-cali-wheel":  ( 93, 1, (-10000, 0, 0, 0), (10000, 0, 0, 0), ("um" , "", "", ""), "Wheel diameter calibration (in micrometers)"),
        "set-cali-axel":   ( 94, 1, (-10000, 0, 0, 0), (10000, 0, 0, 0), ("um" , "", "", ""), "Axel distance calibration (in micrometers)"),
        "get-cali-wheel":  ( 95, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the wheel diameter calibration (in micrometers)"),
        "get-cali-axel":   ( 96, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the axel distance calibration (in micrometers)"),

        "set-turtle-id":   ( 97, 1, (0, 0, 0, 0), (7, 0, 0, 0), ("ID" , "", "", ""), "Set the turtle ID (0-7)"),
        "get-turtle-id":   ( 98, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Get the turtle ID"),

        "load-config":     ( 99, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Reload configuration from EEPROM"),
        "save-config":     (100, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Save configuration to EEPROM"),
        "reset-config":    (101, 0, (0, 0, 0, 0), (0, 0, 0, 0), ("" , "", "", ""), "Reset configuration to defaults"),
    }
